/******************************************************************************
 *  Compilation:  javac FrequencyTableSC
 *  Dependencies: StdIn.java StdOut.java SeparateChainingHashST.java
 *  Execution:    java FrequencyTableSC < words.txt
 *  Data file:    http://introcs.cs.princeton.edu/java/44st/mobydick.txt
 *
 *  Read in a list of words from standard input and print out
 *  each word and the number of times it appears.
 *
 * $ java-algs4 FrequencyTableSC < DATA/Gutenberg/mobydick.txt | head -n8
 *      132  A
 *        7  AD
 *        1  AHAB
 *        4  ALL
 ...
 *        1  Abashed
 *        1  Abednego
 * $ java-algs4 FrequencyTableSC < DATA/Gutenberg/mobydick.txt | sort -nr | head -n8
 *    13553  the
 *     6409  of
 *     5936  and
 *     4463  a
...
public class FrequencyTableSC {
    ...
    public static void main(String[] args) {
        ...
        FrequencyTableSC freq = new FrequencyTableSC();
        while (!StdIn.isEmpty()) {
