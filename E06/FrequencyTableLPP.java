/******************************************************************************
 *  Compilation:  javac FrequencyTableLPP
 *  Dependencies: StdIn.java StdOut.java LinearProbingHashST.java
 *  Execution:    java FrequencyTableLPP < words.txt
 *  Data file:    http://introcs.cs.princeton.edu/java/44st/mobydick.txt
 *
 *  Read in a list of words from standard input and print out
 *  each word and the number of times it appears.
 *
 * $ java-algs4 FrequencyTableLPP < DATA/Gutenberg/mobydick.txt | head -n8
 *      132  A
 *        7  AD
 *        1  AHAB
 *        4  ALL
 ...
 *        1  Abashed
 *        1  Abednego
 * $ java-algs4 FrequencyTableLPP < DATA/Gutenberg/mobydick.txt | sort -nr | head -n8
 *    13553  the
 *     6409  of
 *     5936  and
 *     4463  a
...
public class FrequencyTableLPP {
    private LinearProbingHashPrimesST<String, Integer> st
    ...
    public static void main(String[] args) {
        ...
        FrequencyTableLPP freq = new FrequencyTableLPP();
        while (!StdIn.isEmpty()) {
