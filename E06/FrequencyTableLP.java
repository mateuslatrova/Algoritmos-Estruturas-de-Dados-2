 ...
 *        1  Abashed
 *        1  Abednego
 * $ java-algs4 FrequencyTableLP < DATA/Gutenberg/mobydick.txt | sort -nr | head -n8
 *    13553  the
 *     6409  of
 *     5936  and
 *     4463  a
...
public class FrequencyTableLP {
    ...
    public static void main(String[] args) {
        ...
        FrequencyTableLP freq = new FrequencyTableLP();
        while (!StdIn.isEmpty()) {
