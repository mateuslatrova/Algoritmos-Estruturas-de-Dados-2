/**
 * $ head -n10 DATA/Pwords | java-algs4 WordComponentsPlain
 ...
 * abacaxi abacaxis 
 * $ head -n1000 DATA/Pwords | java-algs4 WordComponentsPlain | head -n5
 * Time to produce wordgraph: 0.185
...
public class WordComponentsPlain
{
